...
For details on enabling the Amazon cloud provider, refer to xref:cluster-deployment/set-up-cloud-providers/amazon.adoc[].

== Setting up the Azure Cloud Provider

For details on enabling the Azure cloud provider, refer to xref:cluster-deployment/set-up-cloud-providers/azure.adoc[].

== Setting up the GCE Cloud Provider

For details on enabling the Google Compute Engine cloud provider, refer to xref:cluster-deployment/set-up-cloud-providers/google-compute-engine.adoc[].
